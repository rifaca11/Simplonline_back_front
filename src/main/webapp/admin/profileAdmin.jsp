    ...
    <div class="bg-white px-8 pb-6 rounded-b shadow-lg">
        ...
        <div x-show="card">
            <form action="/admin/updateProfile" method="post">
                <% List<Admin> selectedAdmin = (List<Admin>) request.getAttribute("data");
                    for(Admin admin : selectedAdmin) {
                %>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <input name="password" type="password" id="password" class="text-sm text-gray-800 bg-white border rounded leading-5 py-2 px-3 border-gray-200 hover:border-gray-300 focus:border-red-300 shadow-sm placeholder-gray-400 focus:ring-0 w-full" readonly="readonly" type="text" placeholder="*******" value="<%= admin.getPassword()%>" />
                        </div>
                    </div>
                </div>
...
<%--                <div class="mt-6">--%>
<%--                    <div class="mb-4">--%>
<%--                        <input type="hidden" name="id" value="<%=selectedAdmin.getId()%>" />--%>
